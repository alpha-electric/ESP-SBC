...
def send_blynk(batt, received_data, refresh = True):
    ...
    if batt == 1:
        if refresh:
            Batt1timedout = False
            Batt1timer = time.time()
        requests.get("https://blynk.cloud/external/api/batch?token=" + BLYNK_AUTH_TOKEN + "&v6=" + received_data[0] + "&v7=" + received_data[1] + "&v8=" + received_data[2] + "&v9=" + received_data[3] + "&v10=" + received_data[4] + "&v11=" + received_data[5] + "&v12=" + received_data[6])
        print("updated batt 1")
    elif batt == 2:
        if refresh:
            Batt2timedout = False
            Batt2timer = time.time()
        requests.get("https://blynk.cloud/external/api/batch?token=" + BLYNK_AUTH_TOKEN + "&v13=" + received_data[0] + "&v0=" + received_data[1] + "&v1=" + received_data[2] + "&v2=" + received_data[3] + "&v3=" + received_data[4] + "&v4=" + received_data[5] + "&v5=" + received_data[6])
